window.BODEGAS = [
  {
    ...
    estado: "activa",
    ubicacion: "Calle Palos de la Frontera n. 14",
    resumen:
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Rubio 1893 SL."
    ],
    lectura:
      "Bodegas Rubio fue fundada en 1946 por Antonio Rubio Gordillo. Inicialmente se ubico en la Bodega de El Cura Aguilar y despues se traslado a la calle Palos de la Frontera n. 14.",
    pendiente:
      "La ficha maquetada no indica coordenadas ni anio de construccion."
  },
  {
    slug: "bodegas-verdier",
    nombre: "Bodegas Verdier",
    estado: "desaparecida",
    ubicacion: "Calle Nicolas Gomez Gonzalez entre el n. 13-14",
    resumen:
    ...
    desaparicion: "1970; urbanizacion La Moncloa en 1989",
    coordenadas: {
      lat: 37.389909,
      lng: -6.555714
    },
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Verdier."
    ],
    lectura:
      "Bodegas Verdier fue fundada en 1891 por Celestino Verdier Martin. La ficha la situa sobre la primitiva destileria de Nicolas Gomez, compuesta por tres naves de crianza en forma de herradura.",
    pendiente:
      "La ficha documenta su relacion con la via ferrea Sevilla-Huelva, la chimenea y las bodegas posteriores Espinosa y Dominguez Rivera."
  },
  {
    slug: "bodegas-morales",
    nombre: "Bodegas Loewenthal - Morales",
    estado: "desaparecida",
    ubicacion: "Calle de la Estacion n. 1",
    resumen:
    ...
    cierre: "1966",
    ubicacionAnterior: "Calle Carlos Mauricio Morales n. 44",
    coordenadas: {
      lat: 37.391774,
      lng: -6.553675
    },
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Loewenthal - Morales."
    ],
    lectura:
      "La sede definitiva se edifico frente a la estacion ferroviaria entre 1898 y 1902, con cerchas metalicas, vigas Warren y una chimenea de 20 m. La bodega cerro en 1966 y sus soleras pasaron a la familia Rubio.",
    pendiente:
      "La ficha la recoge como conservada de manera integra, aunque en estado de abandono y con usos parciales posteriores."
  },
  {
    slug: "bodegas-pichardo",
    nombre: "Bodegas Pichardo",
    estado: "desaparecida",
    ubicacion: "Avenida de la Constitucion y Calle Presidente Adolfo Suarez",
    resumen:
    ...
    desaparicion: "2006; demolicion de El Molino, La Nueva y parte de El Cine",
    coordenadas: {
      lat: 37.390032,
      lng: -6.555545
    },
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Pichardo."
    ],
    lectura:
      "Bodegas Pichardo se organizo en varias naves, como El Cine, El Molino, La Cerca, La Nueva y La Vinagrera. Su actividad ceso en 1985 y parte del conjunto tuvo usos posteriores ligados a Torrepalma y la Cooperativa del Vino.",
    pendiente:
      "La capa QGIS conserva cuatro poligonos para representar las distintas naves del conjunto historico."
  },
  {
    slug: "bodegas-espinosa",
    nombre: "Bodegas Espinosa",
    estado: "desaparecida",
    ubicacion: "Calle Nicolas Gomez Gonzalez entre el n. 13-14 y Ronda de Legionarios 18",
    resumen:
    ...
    anioConstruccion: "1890",
    cierre: "1977",
    desaparicion: "1970; urbanizacion La Moncloa en 1989 para la sede de Nicolas Gomez",
    coordenadas: {
      lat: 37.388255,
      lng: -6.556298
    },
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Espinosa."
    ],
    lectura:
      "Bodegas Espinosa se consolido tras adquirir parte de Bodegas Verdier. Mantuvo la nave El Cortinal en la Ronda de los Legionarios, destinada al soleraje, y cerro en 1977.",
    pendiente:
      "La ficha distingue la antigua nave de Verdier y la nave El Cortinal, recogidas como poligonos en la capa QGIS."
  },
  {
    slug: "bodegas-salas",
    ...
    fuentes: [
      "Rubio Garcia, Blanca. Trabajo de Fin de Grado Arquitectura y memoria perdida del vino, ETSA Universidad de Sevilla, 2026.",
      "Ficha Ejemplo Maquetacion 1.07, Bodegas Salas."
    ],
    lectura:
      "Bodegas Salas se traslado hacia 1930 al final de la calle del Pilar con Avenida de Huelva. El complejo alcanzo 12.000 m2, chimenea, naves de crianza, alambique, oficinas y embotellado.",
    pendiente:
      "La ficha recoge una propuesta de reorganizacion del PGOU de 2005 para viviendas y museo del vino, no ejecutada."
  }
];
